...
function createTextEmail(user) {
	...
	text += "Endeavour to invite friends and family with this link https://fxchange.club/ref?ref="+user.id+"\n";
...
function createHTMLEmail(user) {
	...
	html += "<p>Endeavour to invite friends and family with this <a href=\"https://fxchange.club/ref?ref="+user.id+"\">link</a></p>";
